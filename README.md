...
| **Themes** | Ironclad · Pea Soup | two more, each drawn for a skin below and good on its own |
| **Skins** | Blueprint · Bubblegum · Teletype | three shapes of window, none of which is a palette |
| | Ironclad · Handheld | two windows made of *pictures* — riveted steel, and grey plastic with a screen bezel — generated by `tools/art.mjs` |
...
| | Ironclad · Handheld | the two picture skins with the palettes they were drawn against |
...
crossings are things somebody wants: a drafting-grid chrome in Dracula, and
rounded chrome in Gruvbox.
